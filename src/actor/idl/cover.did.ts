...
export const idlFactory = ({IDL}) => {
  ...
  const ActivityPagination = IDL.Record({
    page_index: IDL.Nat64,
  ...
  const VerificationPagination = IDL.Record({
    page_index: IDL.Nat64,
  ...
  return IDL.Service({
    ...
    getActivities: IDL.Func([PaginationInfo], [ActivityPagination], ['query']),
    getAdmins: IDL.Func([], [IDL.Vec(IDL.Principal)], ['query']),
    getBuildConfigById: IDL.Func([IDL.Principal], [IDL.Opt(BuildConfig)], ['query']),
    getBuildConfigValidator: IDL.Func([BuildConfigInfo], [IDL.Opt(BuildConfig)], ['query']),
    ...
    getVerifications: IDL.Func([PaginationInfo], [VerificationPagination], ['query']),
