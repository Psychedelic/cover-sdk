...
export type CanisterType = {Rust: null} | {Custom: null} | {Motoko: null};
...
export interface _SERVICE {
  ...
  getActivities: ActorMethod<[PaginationInfo], ActivityPagination>;
  getAdmins: ActorMethod<[], Array<Principal>>;
  getBuildConfigById: ActorMethod<[Principal], [] | [BuildConfig]>;
  getBuildConfigValidator: ActorMethod<[BuildConfigInfo], [] | [BuildConfig]>;
